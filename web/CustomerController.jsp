                ...
                <c:forEach var="vehicle" items="${listP}">
                    <tr>
                        ...
                        <td class="action-links">
                            <a href="CustomerRentGetId?vehicle_id=${vehicle.vehicle_id}" class="btn-action" onclick="return confirm('Bạn có chắc chắn muốn thuê phương tiện này không?');">Thuê</a>
                        </td>
                    </tr>
                </c:forEach>
            </c:if>
